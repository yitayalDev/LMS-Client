...
import { Settings, User, Bell, Lock, Save, FileText } from 'lucide-react';
...
export default function InstructorSettings() {
    ...
    const [topic, setTopic] = useState(user?.instructorDetails?.topic || '');
    ...
    useEffect(() => {
        if (user) {
            setName(user.name || '');
            setBio(user.bio || '');
            setTopic(user.instructorDetails?.topic || '');
        }
    }, [user]);
    ...
    const handleProfileSave = async () => {
        setIsLoading(true);
        try {
            const response = await userService.updateProfile({ name, bio, topic });
        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8">
            <div className="flex justify-between items-center">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-sm">Manage your public profile and preferences.</p>
                </div>
            </div>
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center justify-between py-3 border-b">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">Receive emails about student enrollments and activity.</p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between py-3 border-b">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">Get notified about upcoming assignment deadlines.</p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between py-3 border-b">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">Get notified when you receive new messages from students.</p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between py-3">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">Receive a weekly summary of your teaching activity.</p>
                                    </div>
                                    <Switch
